 ...
 * <p>
 *     对拼装Insert SQL的功能加上不能为null的过滤条件
 * </p>
 */
public class InsertNotNullBinKeyHandler extends InsertBinKeyHandler{

    /**
     *
     * @param configuration Mybatis全局配置信息
     */
    public InsertNotNullBinKeyHandler(Configuration configuration) {
        super(configuration);
    }
