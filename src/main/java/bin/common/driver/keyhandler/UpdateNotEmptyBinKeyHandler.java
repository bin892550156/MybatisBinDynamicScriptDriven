...
/**
 * 对应 {@link bin.common.driver.BinKey#KEY_UPDATE_NOT_EMPTY} 的业务处理器。
 * <p>
 *      对拼装UPDATE SQL的功能加上即不为null又不为空字符的过滤条件
 * </p>
 */
public class UpdateNotEmptyBinKeyHandler extends UpdateBinKeyHandler{

    /**
     *
     * @param configuration Mybatis全局配置信息
     */
    public UpdateNotEmptyBinKeyHandler(Configuration configuration) {
        super(configuration);
    }
